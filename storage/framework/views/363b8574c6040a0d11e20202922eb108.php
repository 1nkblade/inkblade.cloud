...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Inkblade.cloud'); ?></title>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            <a href="<?php echo e(route('home')); ?>" class="navbar-brand">
                <img src="<?php echo e(asset('icons/icons8-cat-100.png')); ?>" alt="Inkblade.cloud" class="navbar-logo">
...
<?php /**PATH /var/www/inkblade.cloud/resources/views/layouts/app.blade.php ENDPATH**/ ?>