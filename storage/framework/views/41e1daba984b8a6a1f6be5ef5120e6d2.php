<?php $__env->startSection('title', 'Pibble Belly Washing - Inkblade.cloud'); ?>
...
<div class="container">
    <div class="game-container">
        ...
        <div class="soap-bubbles" id="soap-bubbles"></div>
            <img src="<?php echo e(asset('images/pibble.jpg')); ?>" alt="Pibble" class="pibble-image" id="pibble-image">
        </div>

        <div style="text-align: center;">
            <button class="switch-btn" id="switch-pibble-btn">Switch to Alien Pibble</button>
            <br><br>
            <a href="<?php echo e(route('games')); ?>" class="back-btn">← Back to Games</a>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Pibble images
    const regularPibble = "<?php echo e(asset('images/pibble.jpg')); ?>";
    const alienPibble = "<?php echo e(asset('images/games/alien pibble.jpg')); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/inkblade.cloud/resources/views/games/pibble-belly/index.blade.php ENDPATH**/ ?>