...
<div class="admin-card">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 30px;">
        ...
        <div style="background: rgba(7, 54, 66, 0.3); padding: 25px; border-radius: 10px; border: 1px solid #073642;">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <span style="color: #eee8d5; font-weight: bold;">{{ \App\Models\Project::count() }}</span>
                </div>
                <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="background: rgba(7, 54, 66, 0.3); padding: 25px; border-radius: 10px; border: 1px solid #073642;">
            ...
            <div style="display: flex; flex-direction: column; gap: 15px;">
                <a href="{{ route('feed.refresh') }}" style="color: #93a1a1; text-decoration: none; padding: 10px; border-radius: 5px; transition: all 0.3s ease; border: 1px solid #073642;">
                    <span style="margin-right: 10px;">🔄</span> Refresh Feed
                </a>
                <a href="{{ route('admin.projects.create') }}" style="color: #93a1a1; text-decoration: none; padding: 10px; border-radius: 5px; transition: all 0.3s ease; border: 1px solid #073642;">
                    <span style="margin-right: 10px;">➕</span> New Project
                </a>
                <a href="{{ route('admin.projects.index') }}" style="color: #93a1a1; text-decoration: none; padding: 10px; border-radius: 5px; transition: all 0.3s ease; border: 1px solid #073642;">
                    <span style="margin-right: 10px;">📁</span> Manage Projects
                </a>
                <a href="{{ route('home') }}" target="_blank" style="color: #93a1a1; text-decoration: none; padding: 10px; border-radius: 5px; transition: all 0.3s ease; border: 1px solid #073642;">
