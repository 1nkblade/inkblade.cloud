...
@section('title', 'Test Project - Inkblade.cloud')

@section('content')
<div class="container">
    <div class="project-header">
        <h1>Test Project</h1>
        <p class="project-description">Progetto #1</p>
    </div>
    
    <div class="project-content">
        <div class="project-demo">
            <h2>Progetto</h2>
            <p>Cartella: <code>/projects/test</code></p>
            <p>Percorso: <code>/resources/views/projects//projects/test/</code></p>
            <p>ID Progetto: <code>1</code></p>
        </div>
        ...
        <div class="project-info">
            ...
            <code>/var/www/inkblade.cloud/resources/views/projects//projects/test/</code>
