...
@section('title', 'Games - Inkblade.cloud')
...
<div class="container">
    <div class="games-grid">
        <div class="game-card">
            <img src="{{ asset('images/games/tetris.png') }}" alt="Tetris" class="game-image">
            <div class="game-content">
                ...
                <div class="game-links">
                    <a href="{{ route('games.tetris') }}" class="game-link">Play Game</a>
                </div>
            </div>
        </div>
        
        <div class="game-card">
            <img src="{{ asset('images/games/tic-tac-toe.png') }}" alt="Tic-Tac-Toe" class="game-image">
            <div class="game-content">
                <div class="game-status status-completed">Available</div>
                ...
                <div class="game-links">
                    <a href="{{ route('games.tictactoe') }}" class="game-link">Play Game</a>
                </div>
            </div>
        </div>
        
        <div class="game-card">
            <img src="{{ asset('images/games/pibble.jpg') }}" alt="Pibble Belly Washing" class="game-image">
            <div class="game-content">
                <div class="game-status status-completed">Available</div>
                ...
                <div class="game-links">
                    <a href="{{ route('games.pibble-belly') }}" class="game-link">Wash Pibble</a>
                </div>
            </div>
        </div>
